...
export const TRANSLATIONS = {
  EN: {
    ...
    sensoryDrawerTitle: 'Sommelier Flavor Compass',
    sensoryDrawerDesc: 'Explore all 9 SWRI aroma families and select flavor descriptors.',
  ...
  DE: {
    ...
    sensoryDrawerTitle: 'Sommelier Aromen-Kompass',
    sensoryDrawerDesc: 'Erkunde alle 9 SWRI-Aromafamilien und wähle Geschmacksnoten aus.',
